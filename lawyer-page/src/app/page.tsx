    ...
    <div className={styles.container}>
      ...
      <section className={styles.aboutSection}>
        <article className={styles.aboutBlock}>
          <h2>Обо мне</h2>
          <p>
            Действующий адвокат по уголовным делам с опытом более 10 лет.
            Работаю преимущественно в Москве и Московской области по всем
            стадиям уголовного процесса: доследственная проверка, следствие, суд
            первой инстанции, апелляция, кассация, надзор.
          </p>
          <p>
            До адвокатской практики продолжительное время работал в органах
            предварительного следствия. В первые годы адвокатской деятельности
            основной акцент делал на защите по делам о наркотиках (228 УК РФ),
            позднее сфокусировался на мошенничестве (159 УК РФ) и экономических
            составах. Знание процессуальной механики «изнутри» системы даёт
            заметное преимущество при построении линии защиты.
          </p>
        ...
        <article className={`${styles.aboutBlock} ${styles.aboutBlockAccent}`}>
          ...
          <p>
            ...
            любому исполнителю, готовому за неё заплатить. Я не собираю
            обращения на перепродажу: сам беру трубку, разбираю ситуацию, даю
            первые инструкции и лично выезжаю к задержанному, если требуется
            срочная защита.
          </p>
        ...
        <div className={styles.cardWrapper3card}>
          ...
          <div className={styles.caseCard}>
            <Link href="/situatsii/">
              <img
                src="/raznoye.webp"
                alt="Памятка адвоката: что делать при задержании и обыске в Москве"
                className={styles.caseImage}
                width={800}
                height={600}
                loading="lazy"
