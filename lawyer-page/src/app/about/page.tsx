      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.aboutSection}>
          <div className={styles.aboutContent}>
            <h2>Обо мне</h2>
            <p>
              Являюсь высококлассным адвокатом с многолетним опытом в сфере уголовного права,
              обеспечивая защиту прав и интересов клиентов на самом высоком уровне профессионализма и
              ответственности. Моя практика насчитывает значительное количество положительных
            ...
            <p>
              ...
              способствует успеху в решении самых сложных правовых вопросов.
            </p>
            <p>
