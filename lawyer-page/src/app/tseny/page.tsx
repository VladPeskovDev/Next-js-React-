...
export const metadata = {
  title: "Цены адвоката по уголовным делам — Москва",
  description:
  ...
  keywords:
    "адвокат по уголовным делам цены, стоимость адвоката, услуги адвоката по уголовным делам, адвокат по уголовным делам стоимость",
  ...
  return (
    <main className={`${styles.mainContainer} container mx-auto p-4`}>
      <Head>
        ...
        <meta
          name="keywords"
          content="адвокат по уголовным делам цены, стоимость адвоката, юридическая помощь, защита в суде, услуги адвоката"
        />

        {/* Open Graph для соцсетей и прочего прочего */}
        ...
        <meta
          property="og:image"
          content="https://advokat-peskov.com/1312.webp"
        />
      ...
      <header className={styles.header}>
        <h1 className={styles.title}>
          Прайс-лист на услуги адвоката по уголовным делам
        </h1>
        <p className={styles.subtitle}>
          Ниже представлены ориентировочные цены на услуги. Пожалуйста,
          свяжитесь для уточнения стоимости конкретного дела.
        </p>
      </header>
      ...
      <section className={styles.pricingTable}>
        <h2
          ...
          aria-label="Цены на услуги адвоката по уголовным делам"
        >
        ...
        <div className={styles.pricingItem}>
          <h3 className={styles.serviceTitle}>
            Первичная устная консультация по телефону
          </h3>
          <p className={styles.price}>Бесплатно</p>
        </div>
        <div className={styles.pricingItem}>
          <h3 className={styles.serviceTitle}>
            Устная консультация по уголовному делу в офисе
          </h3>
          <p className={styles.price}>от 5,000 руб.</p>
        </div>
        <div className={styles.pricingItem}>
          <h3 className={styles.serviceTitle}>
            Консультация по уголовному делу с изучением материалов уголовного
            дела
          </h3>
        ...
        <div className={styles.pricingItem}>
          ...
          <p className={styles.price}>от 20,000 руб.</p>
        </div>
        <div className={styles.pricingItem}>
          <h3 className={styles.serviceTitle}>
            Представление интересов на стадии предварительного следствия
          </h3>
          <p className={styles.price}>от 60,000 руб.</p>
        </div>
        <div className={styles.pricingItem}>
          <h3 className={styles.serviceTitle}>
        ...
        <div className={styles.pricingItem}>
          <h3 className={styles.serviceTitle}>
            Защита свидетелей в ходе допроса (суд/следствие/объяснение)
          </h3>
          <p className={styles.price}>от 20,000 руб.</p>
        </div>
        <div className={styles.pricingItem}>
